...
public:
    ...
    // for vertex data
    unsigned int getVertexCount( ) const { return ( unsigned int )vertices.Num( ) / 3; }
    unsigned int getNormalCount( ) const { return ( unsigned int )normals.Num( ) / 3; }
    unsigned int getTexCoordCount( ) const { return ( unsigned int )texCoords.Num( ) / 2; }
    unsigned int getIndexCount( ) const { return ( unsigned int )indices.Num( ); }
    unsigned int getLineIndexCount( ) const { return ( unsigned int )lineIndices.Num( ); }
    unsigned int getTriangleCount( ) const { return getIndexCount( ) / 3; }
    unsigned int getVertexSize( ) const { return ( unsigned int )vertices.Num( ) * sizeof( float ); }
    unsigned int getNormalSize( ) const { return ( unsigned int )normals.Num( ) * sizeof( float ); }
    unsigned int getTexCoordSize( ) const { return ( unsigned int )texCoords.Num( ) * sizeof( float ); }
    unsigned int getIndexSize( ) const { return ( unsigned int )indices.Num( ) * sizeof( triIndex_t ); }
    unsigned int getLineIndexSize( ) const { return ( unsigned int )lineIndices.Num( ) * sizeof( unsigned int ); }
    ...
    const triIndex_t* getIndices( ) const { return &indices[0]; }
    const triIndex_t* getLineIndices( ) const { return &lineIndices[0]; }

    // for interleaved vertices: V/N/T
    unsigned int getInterleavedVertexCount( ) const { return getVertexCount( ); }    // # of vertices
    unsigned int getInterleavedVertexSize( ) const { return ( unsigned int )interleavedVertices.Num( ) * sizeof( float ); }    // # of bytes
