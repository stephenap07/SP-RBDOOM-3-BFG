...
{
    commandList->clearBufferUInt( exposureBuffer, 0 );
}
...
{
    ToneMappingConstants toneMappingConstants = {};
    toneMappingConstants.logLuminanceScale = r_hdrMaxLuminance.GetFloat( ) - r_hdrMinLuminance.GetFloat( );
    toneMappingConstants.logLuminanceBias = r_hdrMinLuminance.GetFloat( );
