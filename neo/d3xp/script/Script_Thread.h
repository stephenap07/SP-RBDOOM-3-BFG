...
private:
	...
	void						Event_GetSkill(); //added for OpenCoop maps support
	void						Event_NumPlayers(); //added for OpenCoop maps support
	...
	void						Event_GiveItemToPlayers( const char* itemName ); //added for OpenCoop maps support
