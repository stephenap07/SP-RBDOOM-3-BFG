...
idCVar g_showWeaponDebug(			"g_showWeaponDebug",		"0",			CVAR_GAME | CVAR_BOOL, "displays the weapon state info for scripting" );
idCVar g_showLuaWindows(			"g_showLuaWindows",			"0",			CVAR_GAME | CVAR_BOOL, "displays the lua windows" );
