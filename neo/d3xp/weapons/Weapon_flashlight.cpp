...
CLASS_DECLARATION( rvmWeaponObject, idWeaponFlashlight )
END_CLASS
...
/*
================
idWeaponFlashlight::Init
================
*/
void idWeaponFlashlight::Init( idWeapon* weapon )
{
...
/*
================
idWeaponFlashlight::UpdateLightIntensity
================
*/
void idWeaponFlashlight::UpdateLightIntensity( void )
{
...
/*
================
idWeaponFlashlight::UpdateSkin
================
*/
void idWeaponFlashlight::UpdateSkin( void )
{
...
/*
================
idWeaponFlashlight::Raise
================
*/
stateResult_t idWeaponFlashlight::Raise( stateParms_t* parms )
{
	enum RisingState
	{
		RISING_NOTSET = 0,
...
/*
================
idWeaponFlashlight::Lower
================
*/
stateResult_t idWeaponFlashlight::Lower( stateParms_t* parms )
{
	enum LoweringState
	{
		LOWERING_NOTSET = 0,
...
/*
================
idWeaponFlashlight::Idle
================
*/
stateResult_t idWeaponFlashlight::Idle( stateParms_t* parms )
{
	enum IdleState
	{
		IDLE_NOTSET = 0,
...
/*
================
idWeaponFlashlight::Fire
================
*/
stateResult_t idWeaponFlashlight::Fire( stateParms_t* parms )
{
	enum FIRE_State
	{
		FIRE_NOTSET = 0,
...
/*
================
idWeaponFlashlight::Reload
================
*/
stateResult_t idWeaponFlashlight::Reload( stateParms_t* parms )
{
	enum RELOAD_State
	{
		RELOAD_NOTSET = 0,
