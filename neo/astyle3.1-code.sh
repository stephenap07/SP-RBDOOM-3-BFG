...
$ASTYLE_BIN -v --formatted --options=astyle3.1-options.ini --exclude="libs" --recursive "*.h"
$ASTYLE_BIN -v --formatted --options=astyle3.1-options.ini --exclude="libs" --exclude="d3xp/gamesys/SysCvar.cpp" --exclude="d3xp/gamesys/Callbacks.cpp" \
